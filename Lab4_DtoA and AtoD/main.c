...
void main(void){
    ...
    DacaRegs.DACOUTEN.bit.DACOUTEN = 1; // enable the dac module output (J3-10)
    ...
    AdcaRegs.ADCSOC1CTL.bit.CHSEL = 2;      // input pin (2 converts ADCINA2, connected to J3-9)
    AdcaRegs.ADCSOC1CTL.bit.ACQPS = 39;     // sample and hold duration

    AdcaRegs.ADCCTL1.bit.INTPULSEPOS = 1;
    AdcaRegs.ADCINTSEL1N2.bit.INT1SEL = 1;  // select EOC1 to trigger interrupt 1
